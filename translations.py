TRANSLATIONS = {
    'de': {
        ...
        'stats_no_data': 'Noch keine Daten für Statistiken vorhanden. Füge zuerst Bücher hinzu!',
        ...
        'pages_short': 'S.',
        'no_search_results': 'Keine passenden Autoren für diese Suche gefunden.',
        ...
        'authors_subtitle': 'Verwalte die Profile deiner Autoren und stöbere in ihren Werken.',
        'no_authors_found': 'Keine Autoren in deiner Bibliothek gefunden.',
        'no_search_results': 'Keine passenden Ergebnisse gefunden.',
        'view_profile': 'Profil anzeigen',
        'back_to_authors': 'Zurück zur Übersicht',
        'edit_author_title': 'Bearbeiten',
        'author_birth': 'Geburtsdatum / Jahr',
        'author_death': 'Sterbedatum / Jahr (optional)',
        'author_img_url': 'Autorenbild URL',
        'author_bio': 'Biografie / Beschreibung',
        'no_bio_available': 'Keine Biografie verfügbar.',
        'notify_author_updated': 'Autorendaten erfolgreich aktualisiert!',
        'books_by_author': 'Bücher dieses Autors',
        ...
        'import_notify_loaded': 'Bücher eingelesen. Starte API-Abruf...',
        ...
        # --- Sektion: Einstellungen (Settings) ---
        ...
        'entry_saved': 'Eintrag gesichert!',
        'book_finished': 'Buch erfolgreich beendet!',
        'date': 'Datum',

        # --- Neuer Lese-Kalender V2 ---
    ...
    'en': {
        ...
        'pages_short': 'p.',
        'no_search_results': 'No matching authors found for this search.',
        ...
        'authors_subtitle': 'Manage your authors\' profiles and browse their works.',
        'no_authors_found': 'No authors found in your library.',
        'no_search_results': 'No matching results found.',
        'view_profile': 'View Profile',
        'back_to_authors': 'Back to Authors',
        'edit_author_title': 'Edit',
        'author_birth': 'Date / Year of Birth',
        'author_death': 'Date / Year of Death (optional)',
        'author_img_url': 'Author Image URL',
        'author_bio': 'Biography / Description',
        'no_bio_available': 'No biography available.',
        'notify_author_updated': 'Author data successfully updated!',
        'books_by_author': 'Books by this author',
        ...
        'import_notify_loaded': 'Books loaded. Starting API lookup...',
        ...
        'entry_saved': 'Log entry saved!',
        'book_finished': 'Book completed successfully!',
        'date': 'Date',

        # --- New Reading Calendar V2 ---
...
# In deiner translations.py ergänzen:
...
def hole_kalender_locale(lang_code='de'):
    ...
    # Fallback auf Deutsch, falls die Sprache nicht existiert
