...
TRANSLATIONS = {
    'de': {
        ...
        'stats_no_data': 'Keine Statistiken vorhanden.',
        ...
        "metadata_sources_title": "Buchdaten-Quellen",
        ...
        "logs_import_error": "[Import] API-Fehler bei ISBN {isbn}: {error}",
        "log_progress_saved": "[Leseprotokoll] Fortschritt gespeichert: +{pages} Seiten bei '{title}'",
        "log_book_finished": "[Leseprotokoll] 🎉 Buch fertig gelesen: {title}",
        "log_title_missing": "[Buch bearbeiten/hinzufügen] Buchtitel fehl",
        'log_book_saved': '[Buch bearbeiten/hinzufügen] Buch {title} erfolgreich gespeichert',
        "log_api_success": "[UI-Suche] Buch-Metadaten via {quelle} geladen: {title}",
        "log_api_fail": "[UI-Suche] WARNUNG: Keine Metadaten für ISBN {isbn} im aktuellen API-Pool gefunden.",
        'log_book_deleted': '[Buch] Buch {title} aus der Datenbank gelöscht',
        'log_cover_updated': '[Buch] Cover aktualisiert für Titel {title}',
        'log_cover_updated_error': '[Buch] Fehler beim Aktualisieren von Cover für Titel {title}',
        'log_metadata_updated': '[Buch] Metadaten für Titel {title} aktualisiert',
        'log_metadata_update_error': '[Buch] Fehler beim Aktualisieren der Metadata für Titel {title}',
        'log_book_log_removed': '[Buch] Leselogeintrag für {title} gelöscht',
        'log_book_cycle_removed': '[Buch] Lesezyklus {cycle} für Titel {title} gelöscht',
        'log_author_data_saved': '[Autor] Autorendaten für {author} erfolgreich gespeichert',
        ...
        'log_creating_backup_data_successful': '[Einstellungen] Erstellen von Komplett-Backup erfolgreich',
        'log_creating_backup_data_error': '[Einstellungen] Fehler beim Erstellen von Komplett-Backup: {error}',
        'log_wrong_backup_data': '[Einstellungen] Keine .db-Datei in Backup gefunden!',
        'log_import_backup_data_successful': '[Einstellungen] Backup erfolgreich eingespielt',
        'log_import_backup_data_error': '[Einstellungen] Fehler beim Einspielen des Backups: {error}',
        'log_reset_success': '[Einstellungen] Reset erfolgreich durchgeführt', 
        'log_reset_error': '[Einstellungen] Fehler beim Reset: {error}',
        'log_create_user_success': '[Einstellungen] Nutzer {name} erfolgreich hinzugefügt',
        'log_create_user_error': '[Einstellungen] Nutzer {name} existiert schon, nichts neu hinzugefügt',
        'log_delete_user_success': '[Einstellungen] Nutzer {name} erfolgreich gelöscht',
        'log_create_shelf_success': '[Einstellungen] Regal {name} erfolgreich erstellt',
        'log_create_shelf_error': '[Einstellungen] Regal {name} existiert schon, nichts neu hinzugefügt',
        'log_delete_shelf_success': '[Einstellungen] Regal {name} erfolgreich gelöscht',
        'log_create_genre_success': '[Einstellungen] Genre {name} erfolgreich erstellt',
    ...
    'en': {
        ...
        'title_missing': 'Titel is missing',
        ...
        "metadata_sources_title": "Book Data Sources",
        ...
        "logs_import_error": "[Import] API error for ISBN {isbn}: {error}",
        "log_progress_saved": "[Reading log] Progress saved: +{pages} pages in '{title}'",
        "log_book_finished": "[Reading log] 🎉 Book finished: {title}",
        "log_title_missing": "[Add/Edit book] Title is missing",
        'log_book_saved': '[Add/Edit book] Book {title} succesfully saved',
        "log_api_success": "[UI-Search] Book metadata loaded via {quelle}: {title}",
        "log_api_fail": "[UI-Search] WARNING: No metadata found for ISBN {isbn} in the current API pool.",
        'log_book_deleted': '[Book] Book {title} deleted from database',
        'log_cover_updated': '[Book] Cover updated for title {title}',
        'log_cover_updated_error': '[Book] Error while updating cover for title {title}',
        'log_metadata_updated': '[Book] Metadata for title {title} updated',
        'log_metadata_update_error': '[Book] Error while updating metadata for title {title}',
        'log_book_log_removed': '[Book] Reading log entry for {title} deleted',
        'log_book_cycle_removed': '[Book] Reading cycle {cycle} for {title} deleted',
        'log_author_data_saved': '[Author] Authors data for {author} saved successfully',
        'log_author_data_save_error': '[Author] Error while fetching authors data for {author}',
        'log_author_data_updated': '[Author] Authors data for {author} updated successfully',
        'log_error_creating_pdf': '[Statistics] Error while creating the PDF: {error}',
        "log_upload_no_data": "[Settings] No ISBN list recognized from file: {error}",
        "log_export_data_successful": "[Settings] Data export as .csv successful",
        "log_export_data_error": "[Settings] Error during data export as .csv: {error}",
        "log_creating_backup_data_successful": "[Settings] Full backup created successfully",
        "log_creating_backup_data_error": "[Settings] Error creating full backup: {error}",
        "log_wrong_backup_data": "[Settings] No .db file found in backup!",
        "log_import_backup_data_successful": "[Settings] Backup restored successfully",
        "log_import_backup_data_error": "[Settings] Error restoring backup: {error}",
        "log_reset_success": "[Settings] Reset performed successfully", 
        "log_reset_error": "[Settings] Error during reset: {error}",
        "log_create_user_success": "[Settings] User {name} added successfully",
        "log_create_user_error": "[Settings] User {name} already exists, nothing added",
        "log_delete_user_success": "[Settings] User {name} deleted successfully",
        "log_create_shelf_success": "[Settings] Shelf {name} created successfully",
        "log_create_shelf_error": "[Settings] Shelf {name} already exists, nothing added",
        "log_delete_shelf_success": "[Settings] Shelf {name} deleted successfully",
        "log_create_genre_success": "[Settings] Genre {name} created successfully",
