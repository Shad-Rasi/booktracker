...
TRANSLATIONS = {
    'de': {
        ...
        'log_cover_updated': '[Buch] Cover für Titel {titel} aktualisiert',
        'log_cover_updated_error': '[Buch] Fehler beim Aktualisieren von Cover für Titel {titel}',
        'log_metadata_updated': '[Buch] Metadaten für Titel {titel} aktualisiert',
        'log_metadata_update_error': '[Buch] Fehler beim Aktualisieren der Metadata für Titel {titel}',
    ...
    'en': {
        ...
        'log_cover_updated': '[Book] Cover for title {titel} updated',
        'log_cover_updated_error': '[Book] Error while updating cover for title {titel}',
        'log_metadata_updated': '[Book] Metadata for title {titel} updated',
        'log_metadata_update_error': '[Book] Error while updating metadata for title {titel}',
